...
const StoriesBar = () => {
  ...
  return (
    <div className="w-screen sm:w-[calc(100vw-240px)] lg:max-w-2xl no-scrollbar overflow-x-auto px-4 no-scrollbar">
      <div className="flex gap-4 pb-5">
        ...
        {stories.map((story, index) => (
          <div
            className={`relative rounded-lg shadow min-w-30 max-w-30 max-h-40 cursor-pointer hover:shadow-lg transition-all duration-200 bg-gradient-to-b
          ...
          >
            ...
            <p className="text-white absolute bottom-1 right-2 z-10 text-xs">
              {moment(story.cretaedAt).fromNow()}
            </p>
