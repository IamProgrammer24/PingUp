...
import { MapPin, MessageCircle, Plus, PlusIcon, UserPlus } from "lucide-react";
  ...
  return (
    ...
    >
      <div>
        ...
        {user.username && (
          <p className="text-gray-500 font-light text-center">@{user.username}</p>
        )}
        {user.bio && (
      ...
      {/* Follow Butto  */}
      <button className="w-full py-2 rounded-md flex justify-center items-center gap-2 bg-gradient-to-r from-indigo-500 to-purple-600
