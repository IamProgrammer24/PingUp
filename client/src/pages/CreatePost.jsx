...
const CreatePost = () => {
  ...
  const handleSubmit = async () => {
    if (!images.length && !content) {
      throw new Error("Please add at least one image or some text");
    }
    ...
    return "success"; // Required for toast.promise success case
  };
            ...
            <button
              ...
              onClick={() =>
                toast.promise(handleSubmit(), {
                  ...
                  success: () => {
                    navigate("/");
                    return <p>Post Added</p>;
                  },
                  error: (err) => <p>{err.message || "Post Not Added"}</p>,
                })
              }
